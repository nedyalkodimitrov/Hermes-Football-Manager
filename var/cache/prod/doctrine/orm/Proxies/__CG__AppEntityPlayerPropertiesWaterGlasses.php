 ...
 */
class WaterGlasses extends \App\Entity\PlayerProperties\WaterGlasses implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\PlayerProperties\\WaterGlasses' . "\0" . 'id', '' . "\0" . 'App\\Entity\\PlayerProperties\\WaterGlasses' . "\0" . 'playerId', '' . "\0" . 'App\\Entity\\PlayerProperties\\WaterGlasses' . "\0" . 'waterGlasses', '' . "\0" . 'App\\Entity\\PlayerProperties\\WaterGlasses' . "\0" . 'date'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WaterGlasses $proxy) {
