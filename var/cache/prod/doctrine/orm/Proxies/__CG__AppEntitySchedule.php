...
class Schedule extends \App\Entity\Schedule implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     */
    public static $lazyPropertiesDefaults = ['date' => NULL, 'startTime' => NULL, 'endTime' => NULL, 'description' => NULL, 'coaches' => NULL];
    ...
    {
        unset($this->date, $this->startTime, $this->endTime, $this->description, $this->coaches);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Schedule' . "\0" . 'id', 'date', 'startTime', 'endTime', 'description', 'coaches'];
        }

        return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Schedule' . "\0" . 'id'];
    }
