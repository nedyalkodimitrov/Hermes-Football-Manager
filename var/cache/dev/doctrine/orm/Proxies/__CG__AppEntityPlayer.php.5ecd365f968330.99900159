...
class Player extends \App\Entity\Player implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     */
    public static $lazyPropertiesDefaults = ['birthDay' => NULL, 'team' => NULL, 'user' => NULL, 'position' => NULL, 'youthTeams' => NULL, 'image' => NULL, 'status' => NULL, 'matchList' => NULL];
    ...
    {
        unset($this->birthDay, $this->team, $this->user, $this->position, $this->youthTeams, $this->image, $this->status, $this->matchList);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Player' . "\0" . 'id', 'birthDay', '' . "\0" . 'App\\Entity\\Player' . "\0" . 'stats', 'team', 'user', 'position', 'youthTeams', '' . "\0" . 'App\\Entity\\Player' . "\0" . 'requestsFromCoaches', 'image', 'status', '' . "\0" . 'App\\Entity\\Player' . "\0" . 'requestToTeam', 'matchList'];
        }

        return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Player' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Player' . "\0" . 'stats', '' . "\0" . 'App\\Entity\\Player' . "\0" . 'requestsFromCoaches', '' . "\0" . 'App\\Entity\\Player' . "\0" . 'requestToTeam'];
    }
